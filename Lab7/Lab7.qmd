...
В quarto.yml, который находится в новом пректе Quarto Website нужно добавить строчку
...
В новом пустом репозитории на GitHub необходимо выполнить настройку: Settings -\> Pages -\> Build and deployment -\> выставить значения main и /docs -\> Save
